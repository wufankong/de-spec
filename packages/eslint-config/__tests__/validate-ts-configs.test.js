...
describe('Validate TS configs', () => {
  it('Validate wufankong-eslint-config/typescript', async () => {
  ...
  it('Validate wufankong-eslint-config/typescript/vue', async () => {
  ...
  it('Validate wufankong-eslint-config/essential/typescript', async () => {
  ...
  it('Validate wufankong-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate wufankong-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate wufankong-eslint-config/typescript/node', async () => {
