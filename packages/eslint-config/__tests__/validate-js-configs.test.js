...
describe('Validate JS configs', () => {
  it('Validate wufankong-eslint-config', async () => {
  ...
  it('Validate wufankong-eslint-config/es5', async () => {
  ...
  it('Validate wufankong-eslint-config/vue', async () => {
  ...
  it('Validate wufankong-eslint-config/essential', async () => {
  ...
  it('Validate wufankong-eslint-config/essential/es5', async () => {
  ...
  it('Validate wufankong-eslint-config/essential/react', async () => {
  ...
  it('Validate wufankong-eslint-config/essential/vue', async () => {
  ...
  it('Validate wufankong-eslint-config/node', async () => {
